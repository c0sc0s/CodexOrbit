...
OrbitAI is the project and umbrella brand. Orbit is the installed Codex extension platform. Orbit Tags is an optional business plugin.
...
Do not imitate OpenAI's logo or describe Orbit as an official extension API. Use the configured repository remote for source links.
