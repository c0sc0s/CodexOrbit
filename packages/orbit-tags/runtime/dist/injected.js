...
var CodexPlugin = (() => {
  ...
  // runtime/src/shared/tag-settings.ts
  ...
  function normalizeColor(value, legacyTone, fallbackColor) {
    ...
    return (typeof legacyTone === "string" ? LEGACY_TONE_COLORS[legacyTone] : void 0) ?? fallbackColor ?? LEGACY_TONE_COLORS.neutral;
  }
  ...
  // runtime/src/shared/title-format.ts
  ...
  // runtime/src/shared/protocol.ts
